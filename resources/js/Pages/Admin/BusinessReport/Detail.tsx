            ...
            <div className="card">
                <div className="card-body">
                    <div className="card-title d-flex justify-content-between">
                        <p>Tracking</p>
                        <a
                            href={route('admin.business-report.tracking.create', { business_report: data.id })}
                            type="button"
                    ...
                    <div className="row">
                        <div className="col-12">
                            <DataTable
                                data={dataTable}
                                columns={column}
                                onEdit={(id) => router.visit(route('admin.business-report.tracking.edit', { business_report: data.id, tracking: id }))}
                                onDelete={(id) => router.delete(route('admin.business-report.tracking.destroy', { business_report: data.id, tracking: id }))} />
                        </div>
                    </div>
                </div>
            </div>
